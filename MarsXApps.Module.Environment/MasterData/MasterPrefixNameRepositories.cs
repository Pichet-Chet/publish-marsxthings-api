...
{
    public interface IMasterPrefixNameRepositories
    {
        public Task<Response> GetAll(MasterPrefixNameFilter param);

        public Task<Response> GetById(int id);

        public Task<Response> Create(MasterPrefixNameModel param);

        public Task<Response> Update(MasterPrefixNameModel param);
    }
    ...
    public class MasterPrefixNameRepositories : IMasterPrefixNameRepositories
    {
        ...
        private readonly IMasterPrefixNameService _service;

        public MasterPrefixNameRepositories()
        {
            _mapper = new Mapper();

            _service = new MasterPrefixNameService();
        ...
        public async Task<Response> GetAll(MasterPrefixNameFilter param)
        {
            ...
            List<MasterPrefixNameModel> Outbound = new List<MasterPrefixNameModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            MasterPrefixNameModel Outbound = new MasterPrefixNameModel();
        ...
        public async Task<Response> Create(MasterPrefixNameModel param)
        {
            Response resp = new Response();

            MasterPrefixName Inbound = new MasterPrefixName();
        ...
        public async Task<Response> Update(MasterPrefixNameModel param)
        {
            Response resp = new Response();
