...
namespace MarsXApps.Module.Environment.MasterData
{
    public interface IMasterCountryRepositories
    {
        ...
        public Task<Response> Create(MasterCountryModel param);

        public Task<Response> Update(MasterCountryModel param);
    }
    ...
    public class MasterCountryRepositories : IMasterCountryRepositories
    {
        ...
        public MasterCountryRepositories()
        {
            ...
            _service = new MasterCountryService();
        ...
        public async Task<Response> GetAll(MasterCountryFilter param)
        {
            ...
            List<MasterCountryModel> Outbound = new List<MasterCountryModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            MasterCountryModel Outbound = new MasterCountryModel();
        ...
        public async Task<Response> Create(MasterCountryModel param)
        {
            Response resp = new Response();

            MasterCountry Inbound = new MasterCountry();
        ...
        public async Task<Response> Update(MasterCountryModel param)
        {
            Response resp = new Response();
