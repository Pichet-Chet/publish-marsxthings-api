...
{
    public interface IMasterProvinceRepositories
    {
        public Task<Response> GetAll(MasterProvinceFilter param);

        public Task<Response> GetById(int id);

        public Task<Response> Create(MasterProvinceModel param);

        public Task<Response> Update(MasterProvinceModel param);
    ...
    public class MasterProvinceRepositories : IMasterProvinceRepositories
    {
        ...
        private readonly IMasterProvinceService _service;

        public MasterProvinceRepositories()
        {
            _mapper = new Mapper();

            _service = new MasterProvinceService();
        ...
        public async Task<Response> GetAll(MasterProvinceFilter param)
        {
            ...
            List<MasterProvinceModel> Outbound = new List<MasterProvinceModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            MasterProvinceModel Outbound = new MasterProvinceModel();
        ...
        public async Task<Response> Create(MasterProvinceModel param)
        {
            Response resp = new Response();

            MasterProvince Inbound = new MasterProvince();
        ...
        public async Task<Response> Update(MasterProvinceModel param)
        {
            Response resp = new Response();
