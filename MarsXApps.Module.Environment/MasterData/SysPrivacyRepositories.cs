...
{
    public interface ISysPrivacyRepositories
    {
        public Task<Response> GetAll(SysPrivacyFilter param);

        public Task<Response> GetById(int id);

        public Task<Response> GetLastVersionActive();

        public Task<Response> Create(SysPrivacyModel param);

        public Task<Response> Update(SysPrivacyModel param);
    }

    public class SysPrivacyRepositories : ISysPrivacyRepositories
    {
        DateTime ServerTime;

        private readonly Mapper _mapper;

        private readonly ISysPrivacyService _service;


        public SysPrivacyRepositories(ISysPrivacyService service)
        {
            _mapper = new Mapper();
        ...
        public async Task<Response> GetAll(SysPrivacyFilter param)
        {
            Response resp = new Response();

            List<SysPrivacyModel> Outbound = new List<SysPrivacyModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            SysPrivacyModel Outbound = new SysPrivacyModel();
        ...
        public async Task<Response> GetLastVersionActive()
        {
            ...
            try
            {
                Outbound = await _service.GetLastVersionActive();
        ...
        public async Task<Response> Create(SysPrivacyModel param)
        {
            Response resp = new Response();

            Service.Models.SysPrivacy Inbound = new Service.Models.SysPrivacy();
        ...
        public async Task<Response> Update(SysPrivacyModel param)
        {
            Response resp = new Response();
