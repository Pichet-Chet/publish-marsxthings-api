...
{
    public interface ICmsContentRepositories
    {
        public Task<Response> GetAll(CmsContentFilter param);

        public Task<Response> GetById(int id);

        public Task<Response> Create(CmsContentModel param);

        public Task<Response> Update(CmsContentModel param);
    }

    public class CmsContentRepositories : ICmsContentRepositories
    {
        DateTime ServerTime;

        private readonly Mapper _mapper;

        private readonly ICmsContentService _service;

        public CmsContentRepositories(ICmsContentService service)
        {
            _mapper = new Mapper();
        ...
        public async Task<Response> GetAll(CmsContentFilter param)
        {
            Response resp = new Response();

            List<CmsContentModel> Outbound = new List<CmsContentModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            CmsContentModel Outbound = new CmsContentModel();
        ...
        public async Task<Response> Create(CmsContentModel param)
        {
            Response resp = new Response();

            CmsContent Inbound = new CmsContent();
        ...
        public async Task<Response> Update(CmsContentModel param)
        {
            Response resp = new Response();
