...
namespace MarsXApps.API.Controllers
{
    ...
    {
        private readonly IMasterBranchRepositories _repositories;


        public MasterBranchController(IMasterBranchRepositories repositories)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] MasterBranchFilter param)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] MasterBranchModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] MasterBranchModel param)
        {
            Response resp = new Response();
