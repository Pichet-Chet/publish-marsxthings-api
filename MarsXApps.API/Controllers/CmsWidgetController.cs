...
namespace MarsXApps.API.Controllers
{
    ...
    public class CmsWidgetController : Controller
    {
        private readonly ICmsWidgetRepositories _repositories;

        public CmsWidgetController(ICmsWidgetRepositories repositories)
        {
            _repositories = repositories;
        }

        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] CmsWidgetFilter param)
        {
        ...
        public async Task<IActionResult> GetByName(string name)
        {
            ...
            try
            {
                ...
                resp = await _repositories.GetAll(cmsWidgetFilter);
            }
            catch (Exception ex)
            {
                resp.Status = Constants.StatusError;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CmsWidgetModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] CmsWidgetModel param)
        {
            Response resp = new Response();
