...
namespace MarsXApps.API.Controllers
{
    ...
    [AllowAnonymous]
    public class PostingFavoriteTransactionController : Controller
    {
        private readonly IPostingFavoriteTransactionRepositories _repositories;

        public PostingFavoriteTransactionController(IPostingFavoriteTransactionRepositories repositories)
        {
            _repositories = repositories;
        }

        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] PostingFavoriteTransactionFilter param)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PostingFavoriteTransactionModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] PostingFavoriteTransactionModel param)
        {
            Response resp = new Response();
