...
namespace MarsXApps.API.Controllers
{
    ...
    public class SysPrivacyController : Controller
    {
        private readonly ISysPrivacyRepositories _repositories;

        public SysPrivacyController(ISysPrivacyRepositories repositories)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] SysPrivacyModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] SysPrivacyModel param)
        {
            Response resp = new Response();
