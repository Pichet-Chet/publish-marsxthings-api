...
namespace MarsXApps.API.Controllers
{
    ...
    public class SasStatusController : Controller
    {
        private readonly ISasStatusRepositories _repositories;

        public SasStatusController(ISasStatusRepositories repositories)
        {
            _repositories = repositories;
        }

        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] SasStatusFilter param)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] SasStatusModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] SasStatusModel param)
        {
            Response resp = new Response();
