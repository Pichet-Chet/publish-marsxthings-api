...
namespace MarsXApps.API.Controllers
{
    ...
    [AllowAnonymous]
    public class PostingCommentController : Controller
    {
        private readonly IPostingCommentRepositories _repositories;

        public PostingCommentController(IPostingCommentRepositories repositories)
        {
            _repositories = repositories;
        }

        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] PostingCommentFilter param)
        {
        ...
        [HttpGet]
        [Route("postingTransaction/{Id}")]
        public async Task<IActionResult> GetPostingTransaction(int Id)
        {
            Response resp = new Response();

            try
            {
                resp = await _repositories.GetPostingTransaction(Id);
            }
            catch (Exception ex)
            {
                resp.Status = Constants.StatusError;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PostingCommentModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] PostingCommentModel param)
        {
            Response resp = new Response();
