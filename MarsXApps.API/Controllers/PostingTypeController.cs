...
namespace MarsXApps.API.Controllers
{
    ...
    {
        private readonly IPostingTypeRepositories _repositories;

        public PostingTypeController(IPostingTypeRepositories repositories)
        {
            _repositories = repositories;
        }

        [HttpGet]
        public async Task<IActionResult> GetAll([FromQuery] PostingTypeFilter param)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] PostingTypeModel param)
        {
            Response resp = new Response();
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] PostingTypeModel param)
        {
            Response resp = new Response();
