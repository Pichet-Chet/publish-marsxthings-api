...
{
    public interface ISasStatusRepositories
    {
        public Task<Response> GetAll(SasStatusFilter param);

        public Task<Response> GetById(int id);

        public Task<Response> Create(SasStatusModel param);

        public Task<Response> Update(SasStatusModel param);
    }

    public class SasStatusRepositories : ISasStatusRepositories
    {
        DateTime ServerTime;

        private readonly Mapper _mapper;

        private readonly ISasStatusService _service;

        public SasStatusRepositories(ISasStatusService service)
        {
            _mapper = new Mapper();
        ...
        public async Task<Response> GetAll(SasStatusFilter param)
        {
            Response resp = new Response();

            List<SasStatusModel> Outbound = new List<SasStatusModel>();
        ...
        public async Task<Response> GetById(int id)
        {
            ...
            SasStatusModel Outbound = new SasStatusModel();
        ...
        public async Task<Response> Create(SasStatusModel param)
        {
            Response resp = new Response();

            SasStatus Inbound = new SasStatus();
        ...
        public async Task<Response> Update(SasStatusModel param)
        {
            Response resp = new Response();
